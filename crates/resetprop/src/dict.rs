...
const WORDS_2: &[&[u8]] = &[
    b"bt", b"hw", b"fm", b"ip", b"nv", b"tp", b"sf", b"wl", b"qc", b"pm",
];
const WORDS_3: &[&[u8]] = &[
    b"sys", b"usb", b"nfc", b"gpu", b"dpi", b"fps", b"vhw", b"cfg", b"dbg",
];
const WORDS_4: &[&[u8]] = &[
    b"wifi", b"core", b"boot", b"init", b"hdmi", b"dram", b"emmc", b"uart", b"mipi",
];
const WORDS_5: &[&[u8]] = &[
    b"audio", b"codec", b"power", b"touch", b"panel", b"radio", b"hapti", b"vibra", b"clock",
];
const WORDS_6: &[&[u8]] = &[
    b"sensor", b"camera", b"modem_", b"memory", b"dalvik", b"vendor", b"kernel", b"source",
];
const WORDS_7: &[&[u8]] = &[
    b"thermal", b"display", b"network", b"storage", b"battery", b"surface", b"charger", b"encoder",
];
const WORDS_8: &[&[u8]] = &[
    b"graphics",
    b"charging",
